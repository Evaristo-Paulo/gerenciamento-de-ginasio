...
class clientController extends Controller
{
    public function list()
    {
        if (Auth::check()) {
            ...
            return view('painel.clients.list', compact('workers'));
        }
    ...
    public function payments()
    {
        if (Auth::check()) {
            ...
            return view('painel.clients.payments', compact('payments', 'months', 'dividas'));
        }
        return redirect()->route('login.form')->with('errorMessage', 'Faça login!');
    }
    public function historics()
    {
        if (Auth::check()) {
            ...
            $payments = $function->payments();
            $payments = $payments;
            return view('painel.clients.historics', compact('payments'));
        }
        return redirect()->route('login.form')->with('errorMessage', 'Faça login!');
    }
    public function paymentRegisterForm()
    {
        if (Auth::check()) {
            ...
            $function = new Client();
            $clients = $function->clients();
            return view('painel.clients.paymentRegisterForm', compact('months', 'clients'));
        }
        return redirect()->route('login.form')->with('errorMessage', 'Faça login!');
    }
    ...
    public function editForm($id)
    {
        if (Auth::check()) {
            ...
            return view('painel.clients.edit', compact('genders', 'provinces', 'ocupations', 'worker'));
        }
        return redirect()->route('login.form')->with('errorMessage', 'Faça login!');
    }
