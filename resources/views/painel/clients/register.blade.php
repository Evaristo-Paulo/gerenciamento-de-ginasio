    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Formulário de Registo |<small>Clientes</small></h2>
                        <div class="clearfix"></div>
                            ...
                            <form class="form-horizontal form-label-left" data-parsley-validate id="form" method="POST"
                                ...
                                <div id="step-1">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="bi" class="form-control col" value="{{ old('bi') }}" required="required" type="text" name="bi">
                                        </div>
                                    </div>
                                ...
                                <div id="step-2">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" required="required"
                                                class="form-control ">
                                        </div>
                                    </div>
                                </div>
                                <div id="step-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input type="text" id="hood" name="hood" value="{{ old('hood') }}" required="required"
                                                class="form-control ">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="select2_single form-control" tabindex="-1" id="municipe"
                                                name="municipe">
                                                <option value="" disabled selected required="required">Aguardando ...</option>
                                            </select>
                                        </div>
                                    </div>
