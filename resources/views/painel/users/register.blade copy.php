                    ...
                    <div class="x_content">
                        ...
                        <div id="wizard" class="form_wizard wizard_horizontal">
                            ...
                            <form class="form-horizontal form-label-left" id="form" method="POST"
                                action="{{ route('worker.register') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div id="step-1">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align"
                                            for="nascimento">Data de Nascimento
                                    ...
                                    <div class="form-group row">
                                        <label for="bi" class="col-form-label col-md-3 col-sm-3 label-align">Nº
                                            BI</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="bi" class="form-control col" type="text" name="bi">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div id="step-2">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="select2_single form-control" tabindex="-1" id="provincia"
                                                name="provincia">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="select2_single form-control" tabindex="-1" id="municipio"
                                                name="municipio">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="bairro">Bairro
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="rua">Rua <span
                                                class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                ...
                                <div id="step-3">
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="cargo">Cargo á
                                            ocupar <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="select2_single form-control" tabindex="-1" id="cargo"
                                                name="cargo">
                                    ...
                                    <div class="form-group row">
                                        <label for="" class="col-form-label col-md-3 col-sm-3 label-align">Salário
                                            (kz)</label>
                                        <div class="col-md-6 col-sm-6 ">
...
@push('css')
    ...
    <!-- iCheck -->
    <link href="{{  url('painel/vendors/iCheck/skins/flat/green.css') }}" rel="stylesheet">
    <link href="{{  url('painel/vendors/select2/dist/css/select2.min.css') }}" rel="stylesheet">
    <link href="{{  url('painel/vendors/switchery/dist/switchery.min.css') }}" rel="stylesheet">
    <link href="{{  url('painel/vendors/starrr/dist/starrr.css') }}" rel="stylesheet">
    <link href="{{  url('painel/vendors/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
